...
class SettingsViewModel(
    ...
    // region [Version Info]
    private val _version by lazy { MutableStateFlow<SettingsRepository.Version?>(null) }
    val version: StateFlow<SettingsRepository.Version?> by lazy { _version.asStateFlow() }
