...
class HomeViewModel(
    ...
    private suspend fun tryDetectOnline(): List<MyModel> {
        ...
        return detectOrThrow(lld, listOf(errorMessage), R.string.lld_json_online)
    }
    ...
    private suspend fun tryDetectOffline(errorMessage: String?): List<MyModel> {
        ...
        return detectOrThrow(lldAndError.first, errorMessages, R.string.lld_json_offline)
    }
    ...
    private suspend fun detectOrThrow(lld: Lld?, errorMessage: List<String?>, @StringRes modeResId: Int): List<MyModel> {
