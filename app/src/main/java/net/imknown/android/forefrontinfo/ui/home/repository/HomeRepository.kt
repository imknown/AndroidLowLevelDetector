...
import net.imknown.android.forefrontinfo.ui.home.datasource.AndroidDataSource.Companion.PROP_RO_PRODUCT_FIRST_API_LEVEL
import net.imknown.android.forefrontinfo.ui.home.datasource.AndroidDataSource.Companion.PROP_SECURITY_PATCH
import net.imknown.android.forefrontinfo.ui.home.datasource.AndroidDataSource.Companion.PROP_VENDOR_SECURITY_PATCH
...
class HomeRepository(
    ...
    fun detectSecurityPatches(lld: Lld): List<MyModel> {
        ...
        val mySecurityPatchVendor = getStringProperty(PROP_VENDOR_SECURITY_PATCH, isAtLeastStableAndroid9())
