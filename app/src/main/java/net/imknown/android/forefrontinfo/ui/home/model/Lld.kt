...
data class Lld(
    ...
    data class Androids(
        ...
        // https://android.googlesource.com/platform/build/+/refs/tags/android-11.0.0_r37/core/build_id.mk
    ...
    @Serializable
    data class Toyboxes(
        // https://android.googlesource.com/platform/external/toybox/+/refs/tags/android-11.0.0_r37/main.c
        val stable: BaseInfo,
        // https://android.googlesource.com/platform/external/toybox/+/refs/tags/android-security-8.1.0_r88/main.c
