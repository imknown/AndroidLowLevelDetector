...
data class Lld(
    ...
    data class Androids(
        ...
        // https://android.googlesource.com/platform/build/+/refs/tags/android-11.0.0_r5/core/build_id.mk
    ...
    @Keep
    data class Toyboxes(
        // https://android.googlesource.com/platform/external/toybox/+/refs/tags/android-11.0.0_r5/main.c
        val stable: BaseInfo,
