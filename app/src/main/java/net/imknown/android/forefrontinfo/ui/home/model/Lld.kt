...
data class Lld(
    ...
    data class Androids(
        ...
        // https://android.googlesource.com/platform/build/+/refs/tags/android-12.0.0_r15/core/build_id.mk
    ...
    @Serializable
    data class Toyboxes(
        // https://android.googlesource.com/platform/external/toybox/+/refs/tags/android-12.0.0_r15/toys.h
        val stable: BaseInfo,
