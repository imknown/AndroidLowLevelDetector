...
| Path | What it is |
|---|---|
| [spec/](spec/README.md) | Product spec (primary; Chinese edition: [spec-cn/](spec-cn/README.md)). Deliberately written without reading the code — when spec and code disagree, verify which one is right, then fix the wrong one |
