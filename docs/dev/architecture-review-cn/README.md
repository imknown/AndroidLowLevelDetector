...
- **[反模式与隐患](04-反模式与隐患.md)**:[AR-09 State 无错误态](04-反模式与隐患.md#AR-09)、[AR-11 资源 ID 当逻辑值](04-反模式与隐患.md#AR-11)、[AR-12 阻塞调用跑 CPU 线程池](04-反模式与隐患.md#AR-12)、[AR-13 零散小问题(剩 8 项)](04-反模式与隐患.md#AR-13)、[AR-14 Prop 页逐 key 查询](04-反模式与隐患.md#AR-14)、[AR-15 lld.json 日期隐式契约](04-反模式与隐患.md#AR-15)、[AR-17 QUERY_ALL_PACKAGES 申报缺档](04-反模式与隐患.md#AR-17)、[AR-18 杂项隐患](04-反模式与隐患.md#AR-18)、[AR-19 字符串当哨兵值](04-反模式与隐患.md#AR-19)、[C1 逐条错误隔离未实现(暂缓)](04-反模式与隐患.md#C1)、[R7 版本合并残留弱点](04-反模式与隐患.md#R7)、[R11 License 合规不到位](04-反模式与隐患.md#R11)、[R13 比对语义逐行 ad hoc](04-反模式与隐患.md#R13)
...
按类型分册;组内大致按严重程度优先排列。C/R/A 条目按并入后的分册排列。已修复的条目(AR-10 mounts 缓存、AR-13.1/13.2/13.4/13.11/13.14、AR-17 的 VIEW 残留、R9 商店页、C2)已从本报告删除,记录见 git 历史;AR-13.12(`detectWebView` 的 Android 6 分支)原为裁定关闭、条目保留,2026-09-22 该分支随 minSdk 24 删除后已无对象,条目一并移除,见 [S6](#appendix-a)。
...
| [AR-13](04-反模式与隐患.md#AR-13) | 零散小问题(原 14 项,已修复 5 项、消解 1 项,剩 8 项) | P2 | 低 | 单项影响小,攒多了拖慢整体质量 |
